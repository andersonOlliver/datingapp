...
export class UserService {
  ...
  getUsers(
    ...
    if (userParams != null) {
      queryString += `minAge=${userParams.minAge}&maxAge=${userParams.maxAge}&gender=${userParams.gender}&orderBy=${
        userParams.orderBy
      }`;
    }
  ...
  markAsRead(userId: number, messageId: number) {
    return this.authHttp
      .post(`${this.baseUrl}users/${userId}/messages/${messageId}/read`, {}).subscribe();
  }
